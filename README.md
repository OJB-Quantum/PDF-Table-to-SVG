# PDF-Table-to-SVG
A tool that runs in the browser using Google Colab and a Graphics Processing Unit (GPU) to identify and convert located tables into Scalable Vector Graphics (SVG) outputs. Control knobs are included for easy parameter adjustment. 
